# This Makefile is for the RTF extension to perl.
#
...
#	EXE_FILES => [q[rtf2html]]
#	NAME => q[RTF]
#	VERSION_FROM => q[RTF/Parser.pm]
...
PM_TO_BLIB = RTF/HTML/char_map \
	$(INST_LIBDIR)/RTF/HTML/char_map \
	RTF/HTML/ansi \
	$(INST_LIBDIR)/RTF/HTML/ansi \
	RTF/HTML/Output.pm \
	$(INST_LIBDIR)/RTF/HTML/Output.pm \
	RTF/Charsets.pm \
	$(INST_LIBDIR)/RTF/Charsets.pm \
	RTF/Parser.pm \
	$(INST_LIBDIR)/RTF/Parser.pm \
	RTF/Config.pm \
	$(INST_LIBDIR)/RTF/Config.pm \
	RTF/Control.pm \
	$(INST_LIBDIR)/RTF/Control.pm
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/RTF/HTML/char_map $(INST_LIBDIR)/RTF/HTML/ansi $(INST_LIBDIR)/RTF/HTML/Output.pm $(INST_LIBDIR)/RTF/Charsets.pm $(INST_LIBDIR)/RTF/Parser.pm $(INST_LIBDIR)/RTF/Config.pm $(INST_LIBDIR)/RTF/Control.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"RTF-Parser\" VERSION=\"1,03,0,0\">\n}. qq{\t<TITLE>RTF-Parser</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > RTF-Parser.ppd
